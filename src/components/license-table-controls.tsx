...
import { deleteUnusedLicenseAction, updateLicenseStatusAction } from "@/app/actions";
...
export function LicenseRowActions({ licenseId, canDelete, hasDownload }: LicenseRowActionsProps) {
  const router = useRouter();
  const [isPending, startTransition] = useTransition();
